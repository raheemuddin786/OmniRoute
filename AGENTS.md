...
| Agent features                     | `src/lib/{acp,memory,skills,cloudAgent}/`               | [`docs/frameworks/AGENT_PROTOCOLS_GUIDE.md`](docs/frameworks/AGENT_PROTOCOLS_GUIDE.md), [`docs/frameworks/SKILLS.md`](docs/frameworks/SKILLS.md), [`docs/guides/AGENT_MEMORY_AND_KNOWLEDGE_GUIDE.md`](docs/guides/AGENT_MEMORY_AND_KNOWLEDGE_GUIDE.md) |
